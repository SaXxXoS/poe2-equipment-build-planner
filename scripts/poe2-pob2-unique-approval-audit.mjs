...
write('poe2-pob2-unique-license-distribution.json', { schemaVersion:'1.0.0', task:'5M.2.8', pin, codeLicense:{status:'confirmed',license:'MIT',file:'LICENSE.md',attributionRequired:true}, bundledItemData:{origin:'GGG-labelled and community-maintained planner data',licenseCoverage:'license-scope-unknown',distributionStatus:'distribution-pending-both'}, operations:{localAudit:'allowed',buildProcessing:'audit-only-until-confirmed',repositoryStorage:'forbidden-until-confirmed',generatedProductStorage:'distribution-pending-both',githubPagesDistribution:'distribution-pending-both',runtimeLoading:'forbidden',hotlinks:'forbidden'}, attributionPlan:['README','DATA_SOURCE_REFERENCES','THIRD_PARTY_NOTICES.md','source repository and exact commit','planner-data and non-GGG-ID disclaimer'], legalAdvice:false })
...
write('poe2-pob2-unique-approval-decision.json', { schemaVersion:'1.0.0', task:'5M.2.8', sourceId, scopeId, pin, decision:'conditionally-approved', auditStatus:'allowed', importStatus:'blocked-pending-distribution-confirmations', distributionStatus:'distribution-pending-both', localizationStatus:'not-approved', gggIdStatus:'not-claimed', approvedPurpose:'Unique planner data only', forbiddenReplacementScopes:['GGG technical affixes','base item completeness','item class completeness','German CSD','crafting data','socketables','skills','supports','media'], productFilesChanged:false, realPob2RecordsImported:false, nextTask:'Manual PoB2-maintainer and GGG clarification before 5M.2.9' })
