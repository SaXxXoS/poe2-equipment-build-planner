...
export interface SpiritCapacityState { weaponSet:'set-1'|'set-2';confirmedMinimumCapacity:number;reservedSpirit:number|null;remainingSpirit:number|null;status:'fits-confirmed-minimum'|'exceeds-confirmed-minimum'|'blocked-incomplete-reservation-chain'|'no-reservations';passiveResourceEffects:PassiveResourceEffect[] }
