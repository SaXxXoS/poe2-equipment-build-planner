...
export interface DamageEstimate {
  ...
  resourceSpiritModel?:{modelVersion:string;productive:false;manaPoolKnown:false;lifePoolKnown:false;spiritCapacityKnown:false;exactSkillCostsKnown:boolean;sources:ResourceSpiritSource[];equipmentContributions:EquipmentResourceContribution[];skillCostChains:SkillResourceCostChain[];semanticSupportCostHints:Array<{supportId:string;value:number}>;limitations:string[]}
