import { placeholderMetadata, type AppliedModifier, type BuildInput, type MechanicTag, type ModifierCategory, type ModifierDefinition, type SupportGemDefinition } from '../../domain'
...
const skill = (id: string, tags: Parameters<typeof placeholderMetadata>[2]) => placeholderMetadata(id, id, tags)
