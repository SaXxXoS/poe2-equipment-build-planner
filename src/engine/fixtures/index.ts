import { placeholderMetadata, type AppliedModifier, type BuildInput, type MechanicTag, type ModifierCategory, type ModifierDefinition, type PassiveNodeDefinition, type SkillGemDefinition, type SupportGemDefinition } from '../../domain'
