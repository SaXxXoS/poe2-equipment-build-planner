...
export interface ImportedTreeConnection { id: string; fromNodeId: string; toNodeId: string; connectionType: 'passive-tree'; directed: false; hideInDefaultState?: true; touchesMastery?: true; orbit?: number; orbitCenter?: { x:number; y:number }; sourceReference: string }
