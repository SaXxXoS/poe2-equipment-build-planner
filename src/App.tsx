...
import { Pob2UniqueDisplaySection } from './components/Pob2UniqueDisplaySection'
...
export default function App() {
  ...
  return <>
    <header>
      <p className="eyebrow">Equipment-first · Mobiler Prototyp</p>
      <h1>PoE2 Equipment Build Planner</h1>
      <p>Plane einen Build ausgehend von deiner Ausrüstung. Der offizielle Passivbaum kann experimentell im Worker analysiert werden; übrige Ergebnisse bleiben lokale Platzhalter.</p>
    </header>
    <main>
      <CharacterSection value={character} onChange={setCharacter}/>
      <EquipmentSection entries={equipment} setEntries={setEquipment}/>
      <SkillsSection setups={setups} onChange={setSetups}/>
      ...
      <Pob2UniqueDisplaySection/>
      <section className="calculate">
        <h2>8. Test-Build berechnen</h2>
        <p>Dieser getrennte Ergebnisbereich verwendet weiterhin lokale Platzhalter.</p>
        <button className="calculate-btn" onClick={calculate}>Test-Build berechnen</button>
      </section>
      {calculated && <BuildResultSection result={buildResult}/>}
    </main>
    <footer>Prototyp mit lokalen Platzhalterdaten · Keine Verbindung zu PoE2DB</footer>
  </>
}
