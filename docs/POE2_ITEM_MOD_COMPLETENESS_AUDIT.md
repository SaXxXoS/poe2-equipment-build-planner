...
> **5M.2.3:** Der Offline-Auditparser klassifiziert nun alle 2.255 Mods, 2.705 Statzeilen, 431 Stat-IDs, 444 Kombinationen und 429 Mehrzeiler/Hybride. IDs, Statfolgen und Intervalle stimmen vollständig; wegen fehlender Domain-/Generation-/Klassenreferenztabellen bleibt Modcoverage `partially-resolved`. 447/485 Templatelücken besitzen CSD-Strukturen. Keine Produktdatei wurde verändert.
# Stand nach 5M.2.4
