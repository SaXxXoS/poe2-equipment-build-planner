...
Die technischen Jewel-/Charm-/Flask-Scopes geben keine deutschen Namen oder Stattexte frei. Alle entsprechenden Sprachkategorien bleiben `pending`; kein 5M.1B-Datensatz wurde verändert.
